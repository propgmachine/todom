...
todoBtn.addEventListener('click', () => {
 ...
 //check if input is empty before adding to list
  if (input.value !== '') {
    addItems(todoObj)
    refresh()
    input.value = ''
...
const toggle = document.querySelector('.todo-list')
...
//Rusty Mode
const rustyMode = document.querySelector('.rusty-mode-btn')
rustyMode.addEventListener('click', () => {
  document.body.classList.toggle('rusty-mode')
})